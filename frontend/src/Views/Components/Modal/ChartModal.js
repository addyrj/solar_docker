...
import { chartOptionList, chrtListOpt2 } from "../../../JavaScript/ChartMain";
...
// import React from "react";
// import styled from "styled-components";
// import { chartOptionList } from "../../../JavaScript/ChartMain"; // Changed from chrtListOpt2 to chartOptionList
// import { chhoseGraphState } from "../../../Database/Action/ConstantAction";
// import { useDispatch } from "react-redux";
...
//           <div className="col-12 mb-20">
//             <div className="row row-cols-1 row-cols-lg-4 g-6 graphlayout">
//               {chartOptionList.map((item, index) => { // Changed from chrtListOpt2 to chartOptionList
//                 return (
//                   <div key={index} style={{ margin: "10px 0px " }}> {/* Added key prop */}
//                     <img
//                       src={item.path}
